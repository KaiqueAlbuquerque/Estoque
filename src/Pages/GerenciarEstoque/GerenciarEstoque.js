...
const GerenciarEstoque = () => {
    const [state, setState] = React.useState({
        columns: [
            ...
            { title: 'Cód Barras', field: 'codBarras' },
            { title: 'Quantidade', field: 'quantidade', type: 'numeric' },
            { title: 'Preço', field: 'preco' }
        ],
        data: [
          { descricao: 'Baran', codBarras: '123456789', preco: 'R$ 25,00', quantidade: 34 },
          { descricao: 'Kaique', codBarras: '987654321', preco: 'R$ 25,00', quantidade: 50 },
          { descricao: 'Baran', codBarras: '123456789', preco: 'R$ 25,00', quantidade: 34 },
          { descricao: 'Kaique', codBarras: '987654321', preco: 'R$ 25,00', quantidade: 50 },
          { descricao: 'Baran', codBarras: '123456789', preco: 'R$ 25,00', quantidade: 34 },
          { descricao: 'Kaique', codBarras: '987654321', preco: 'R$ 25,00', quantidade: 50 },
